        ...
        <Section id="features"  title="Property Features" propertyId={propertyId} isEditing={editingSections["features"]} saving={saving} toggleEdit={toggleEdit}>
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-6">
            ...
            <label className="block sm:col-span-2">
              ...
              <textarea rows={2} value={values.deed_note} onChange={(e) => set("deed_note", e.target.value)} className="w-full border border-stone-line px-3 py-2" />
            </label>
          </div>
        ...
        <Section id="media_seo" propertyId={propertyId} isEditing={editingSections["media_seo"]} saving={saving} toggleEdit={toggleEdit} title={
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-2">
                  {values.gallery.map((img, i) => (
                    <div key={i} className="relative border border-stone-line bg-white p-2">
                      ...
                      <input 
                        type="text" 
                        placeholder="Caption (Max 40 chars)" 
                        maxLength={40}
                        value={img.caption} 
                        onChange={(e) => {
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block sm:col-span-2">
              ...
              <input value={values.meta_title} onChange={(e) => set("meta_title", e.target.value)} placeholder={values.title} className="w-full border border-stone-line px-3 py-2 bg-stone-50" />
            </label>
            <label className="block sm:col-span-2">
              <span className="mb-1 block text-xs text-ink-soft">Meta Description (SEO) - Falls back to short description</span>
              <textarea rows={2} value={values.meta_description} onChange={(e) => set("meta_description", e.target.value)} placeholder={values.short_description} className="w-full border border-stone-line px-3 py-2 bg-stone-50" />
            </label>
          </div>
        </Section>
